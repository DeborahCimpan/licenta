...
public class SpParts {
    ...
    public SpParts(int id, String part_number, String spare_id, String spare_desc, String spare_details) {
        this.id = id;
    ...
    public String toString() {
        return "SpParts{" + "id=" + id + ", part_number=" + part_number + ", spare_id=" + spare_id + ", spare_desc=" + spare_desc + ", spare_details=" + spare_details + '}';
    }
